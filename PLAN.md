...
- [x] Task 17: Phase 6 final + DONE.md
...
- Background session polling added: all non-active sessions have their pane content captured every ~2s (tick%13), so status dots update while working in another session.
